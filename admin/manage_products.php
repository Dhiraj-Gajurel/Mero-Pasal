...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    ...
    $stmt = $pdo->prepare("DELETE FROM product_ratings WHERE product_id = ?");
    $stmt->execute([$id]);

    // 3. Delete related orders (if you want old orders removed too, optional)
...
<head>
    ...
    <title>Manage Products -Mero-Pasal</title>
